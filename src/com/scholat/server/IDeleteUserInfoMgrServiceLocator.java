...
public class IDeleteUserInfoMgrServiceLocator extends org.apache.axis.client.Service implements com.scholat.server.IDeleteUserInfoMgrService {
    ...
    private java.lang.String deleteUser_address = "http://122.228.202.163:7080/UserWebService/services/deleteUser";
    ...
    public com.scholat.server.IDeleteUserInfoMgr getdeleteUser() throws javax.xml.rpc.ServiceException {
    ...
    public com.scholat.server.IDeleteUserInfoMgr getdeleteUser(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.scholat.server.DeleteUserSoapBindingStub _stub = new com.scholat.server.DeleteUserSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.scholat.server.IDeleteUserInfoMgr.class.isAssignableFrom(serviceEndpointInterface)) {
                com.scholat.server.DeleteUserSoapBindingStub _stub = new com.scholat.server.DeleteUserSoapBindingStub(new java.net.URL(deleteUser_address), this);
                _stub.setPortName(getdeleteUserWSDDServiceName());
                return _stub;
            }
        }
