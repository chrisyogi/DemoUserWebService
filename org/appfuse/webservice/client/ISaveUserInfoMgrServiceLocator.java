...
public class ISaveUserInfoMgrServiceLocator extends org.apache.axis.client.Service implements org.appfuse.webservice.client.ISaveUserInfoMgrService {
    ...
    private java.lang.String saveUser_address = "http://122.228.202.163:8080/UserWebService/services/saveUser";
    ...
    public org.appfuse.webservice.client.ISaveUserInfoMgr getsaveUser() throws javax.xml.rpc.ServiceException {
    ...
    public org.appfuse.webservice.client.ISaveUserInfoMgr getsaveUser(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.appfuse.webservice.client.SaveUserSoapBindingStub _stub = new org.appfuse.webservice.client.SaveUserSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.appfuse.webservice.client.ISaveUserInfoMgr.class.isAssignableFrom(serviceEndpointInterface)) {
                org.appfuse.webservice.client.SaveUserSoapBindingStub _stub = new org.appfuse.webservice.client.SaveUserSoapBindingStub(new java.net.URL(saveUser_address), this);
                _stub.setPortName(getsaveUserWSDDServiceName());
                return _stub;
            }
        }
